      ...
      <div className="text-center my-8">
        <div className="flex border-b-2 my-5 w-1/2 mx-auto justify-center items-center">
          <div
            ...
            className={`py-2 px-3 mx-2 text-xl ${activeTab === "All"
          ...
          <div
            ...
            className={`py-2 px-3 mx-2 text-xl ${activeTab === "math"
                ? "border-b-4 border-yellow-900 text-yellow-900 font-semibold"
                : ""
              }`}
          >
          ...
          <div
            ...
            className={`py-2 px-3 mx-2 text-xl ${activeTab === "languge"
                ? "border-b-4 border-yellow-900 text-yellow-900 font-semibold"
                : ""
              }`}
          >
          ...
          <div
            ...
            className={`py-2 px-3 mx-2 text-xl ${activeTab === "science"
                ? "border-b-4 border-yellow-900 text-yellow-900 font-semibold"
                : ""
              }`}
          >
